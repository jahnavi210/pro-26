...
function keyPressed() {
	if (keyCode === UP_ARROW) {
		//CODE TO APPLY A KEYPRESSED TO CHANGE THE POSITION OF BALL OBJECT TO THE LEFT WHEN UP ARROW KEY IS PRESSED
       Matter.Body.applyForce(bob1.body,bob1.body.position,{x:-60,y:155})
	}
}
